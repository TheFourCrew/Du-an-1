            ...
            <div class="row">
                <div class="col-md-12 col-sm-6 ctsp">
                    ...
                    <div class="col-md-6 col-sm-6 thongsoctsp">
                        ...
                        <p ><b><span style="color:red;">Giá bán:</span><span style="color:red;" class="giaban"> <%=formatter.format(giaBan) + " VNĐ"%></span><span style="color:red;"> VNĐ</span></b><span > (Đã bao gồm thuế VAT)</span></p>
