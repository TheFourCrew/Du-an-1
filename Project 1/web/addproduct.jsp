                        ...
                        <form class="form-horizontal" action="AddProduct" name="fProduct" method="post" onsubmit="return validateFormProduct()" enctype="multipart/form-data" id="addproduct">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3 col-md-2">
                                    <input type="button" name="prod-tags" value="Thêm" data-toggle="modal" data-target="#themLoai" class="btn btn-info">
                                    <!-- Modal -->
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <!--modal content-->
                                                    <div class="form-group">
                                                        <label class="control-label col-sm-2 col-md-3" for="prod-tags">Tên loại<em>*</em>:</label>
                                                        <div class="col-sm-3 col-md-7">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="control-label col-sm-2 col-md-3" for="prod-tags">Ghi chú:</label>
                                                        <div class="col-sm-3 col-md-7">
                                                            <input type="text" name="prod-tags" placeholder="Nhập thẻ" class="form-control" id="prod-tags">
                                                        </div>
                                                    </div>
