...
--
-- Table structure for table `article_detail_images`
--

DROP TABLE IF EXISTS `article_detail_images`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `article_detail_images` (
  `idarticle_detail_images` int(11) NOT NULL AUTO_INCREMENT,
  `id_article` int(11) NOT NULL,
  `id_detail_image` int(11) NOT NULL,
  PRIMARY KEY (`idarticle_detail_images`),
  UNIQUE KEY `idarticle_detail_images_UNIQUE` (`idarticle_detail_images`),
  KEY `article_idx` (`id_article`),
  KEY `detail_idx` (`id_detail_image`),
  CONSTRAINT `article` FOREIGN KEY (`id_article`) REFERENCES `article` (`idarticle`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
--
-- Dumping data for table `article_detail_images`
--

LOCK TABLES `article_detail_images` WRITE;
/*!40000 ALTER TABLE `article_detail_images` DISABLE KEYS */;
/*!40000 ALTER TABLE `article_detail_images` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `product_size` (
  ...
  KEY `size_value_idx` (`id_size`),
  CONSTRAINT `product_size` FOREIGN KEY (`id_product`) REFERENCES `product` (`idproduct`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `size_value` FOREIGN KEY (`id_size`) REFERENCES `size` (`idsize`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `size` (
  ...
  `size_symbol` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`idsize`),
  UNIQUE KEY `idsize_UNIQUE` (`idsize`),
  UNIQUE KEY `size_symbol_UNIQUE` (`size_symbol`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `vendor` (
  ...
  `vendor_name` varchar(45) CHARACTER SET utf8 NOT NULL,
  `vendor_address` varchar(100) CHARACTER SET utf8 NOT NULL,
  `vendor_phone` varchar(11) CHARACTER SET utf8 DEFAULT NULL,
  `note` varchar(150) COLLATE utf8_unicode_ci DEFAULT NULL,
...
-- Dump completed on 2016-11-19 11:50:57
